...
% TODO Add your title
\title{Real-time Mapping for Fixed-wing navigation using Monocular Vision}
...
\supervisionA{Alexis Konstantinos}
\supervisionB{Rehder Jörn}
...
\cleardoublepage
\input{chapters/direct_monocular_slam}
\cleardoublepage
\input{chapters/keyframe_pose_recovery}
\cleardoublepage
\input{chapters/lsdslam_with_gtsam}
\cleardoublepage
